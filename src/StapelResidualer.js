        ...
        .then((data) => {
          const kommunData = data.filter(
            (item) =>
              ...
              item[`${selectedMetric}_np_${selectedSubject}_${actualYear}`] !=
                null &&
              item[
                `mo_${selectedMetric}_np_${selectedSubject}_${actualYear}`
              ] != null
          );
          ...
          const residuals = kommunData.map((skola) => {
            ...
            const predictedValue =
              skola[`mo_${selectedMetric}_np_${selectedSubject}_${actualYear}`];
  ...
  return (
    <div className="chart-container">
      <div className="description-container">
        <h2>Residualer för skolor i {selectedKommun}</h2>
        <p>
          Diagrammet visar residualerna (differensen mellan faktisk och
          predikterad betygspoäng) för den skolor i {selectedKommun} det valda
          året. Vald skola är markerad med röd färg.
        </p>
      </div>
